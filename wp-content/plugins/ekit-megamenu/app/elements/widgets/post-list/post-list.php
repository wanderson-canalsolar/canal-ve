...
class Ekit_Widget_Post_List extends Widget_Base {

 
	public function get_name() {
		return 'ekit-post-list';
	}

 
	public function get_title() {
		return esc_html__( 'Post List', 'ekit-megamenu' );
	}
	...
	public function get_keywords() {
		return [ 'icon list', 'icon', 'list', 'post list', 'post' ];
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'link',
			[
                'label' =>esc_html__('Select Post', 'ekit-megamenu'),
