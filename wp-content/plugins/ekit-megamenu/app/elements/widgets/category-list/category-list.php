...
class Ekit_Widget_Category_List extends Widget_Base {

 
	public function get_name() {
		return 'ekit-category-list';
	}

 
	public function get_title() {
		return esc_html__( 'Category List', 'ekit-megamenu' );
	}
	...
	public function get_keywords() {
		return [ 'icon list', 'icon', 'list', 'category list', 'category' ];
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'link',
			[
                'label' =>esc_html__('Select Category', 'ekit-megamenu'),
