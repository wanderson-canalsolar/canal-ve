...
class Ekit_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'css-image-choose-control',  EKIT_MEGAMENU_ELEMENTS_URL . 'controls/icon/assets/css/icofonts.css', [], '1.0.0' );
		wp_enqueue_style( 'css-image-choose-control' );
    }
	...
	public static function get_icons() {
		...
		$icons = array(
                  ...
                  'icon icon-working_process_icons_1' => 'icon icon-working_process_icons_1',
                  'icon icon-working_process_icons_2' => 'icon icon-working_process_icons_2',
                  'icon icon-working_process_icons_3' => 'icon icon-working_process_icons_3',
                  'icon icon-working_process_icons_4' => 'icon icon-working_process_icons_4',
                  ...
                  'icon icon-abacus2' => 'icon icon-abacus2',
                  ...
                  'icon icon-book2' => 'icon icon-book2',
                  ...
                  'icon icon-calculator3' => 'icon icon-calculator3',
                  ...
                  'icon icon-checked2' => 'icon icon-checked2',
                  'icon icon-clip' => 'icon icon-clip',
                  'icon icon-clip2' => 'icon icon-clip2',
                  ...
                  'icon icon-cloud-computing2' => 'icon icon-cloud-computing2',
                  'icon icon-cloud-computing-1' => 'icon icon-cloud-computing-1',
                  'icon icon-cogwheel2' => 'icon icon-cogwheel2',
                  ...
                  'icon icon-credit-card2' => 'icon icon-credit-card2',
                  ...
                  'icon icon-diamond3' => 'icon icon-diamond3',
                  ...
                  'icon icon-email2' => 'icon icon-email2',
                  ...
                  'icon icon-favorites2' => 'icon icon-favorites2',
                  ...
                  'icon icon-folders2' => 'icon icon-folders2',
                  ...
                  'icon icon-home3' => 'icon icon-home3',
                  ...
                  'icon icon-id-card2' => 'icon icon-id-card2',
                  ...
                  'icon icon-inbox2' => 'icon icon-inbox2',
                  ...
                  'icon icon-light-bulb2' => 'icon icon-light-bulb2',
                  'icon icon-like2' => 'icon icon-like2',
                  ...
                  'icon icon-medal2' => 'icon icon-medal2',
                  'icon icon-megaphone' => 'icon icon-megaphone',
                  'icon icon-megaphone2' => 'icon icon-megaphone2',
                  ...
                  'icon icon-monitor2' => 'icon icon-monitor2',
                  'icon icon-music2' => 'icon icon-music2',
                  ...
                  'icon icon-safebox2' => 'icon icon-safebox2',
                  'icon icon-search3' => 'icon icon-search3',
                  'icon icon-search-1' => 'icon icon-search-1',
                  'icon icon-settings2' => 'icon icon-settings2',
                  'icon icon-settings-1' => 'icon icon-settings-1',
                  ...
                  'icon icon-shopping-cart3' => 'icon icon-shopping-cart3',
                  ...
                  'icon icon-smartphone3' => 'icon icon-smartphone3',
                  ...
                  'icon icon-users3' => 'icon icon-users3',
                  ...
                  'icon icon-menu2' => 'icon icon-menu2',
                  'icon icon-arrow_down' => 'icon icon-arrow_down',
                  ...
                  'icon icon-key3' => 'icon icon-key3',
                  'icon icon-migration' => 'icon icon-migration',
                  'icon icon-play2' => 'icon icon-play2',
                  'icon icon-quote3' => 'icon icon-quote3',
                  'icon icon-burger-menu' => 'icon icon-burger-menu',
                  'icon icon-chat-bubble' => 'icon icon-chat-bubble',
                  'icon icon-clocks' => 'icon icon-clocks',
                  'icon icon-dollars' => 'icon icon-dollars',
                  'icon icon-forwards' => 'icon icon-forwards',
                  'icon icon-planes' => 'icon icon-planes',
                  'icon icon-tags2' => 'icon icon-tags2',
                  'icon icon-icon_01' => 'icon icon-icon_01',
                  'icon icon-icon_02' => 'icon icon-icon_02',
                  'icon icon-icon_03' => 'icon icon-icon_03',
                  'icon icon-icon_04' => 'icon icon-icon_04',
                  'icon icon-icon_05' => 'icon icon-icon_05',
                  'icon icon-icon_06' => 'icon icon-icon_06',
                  'icon icon-arrow_black' => 'icon icon-arrow_black',
                  'icon icon-arrow_left' => 'icon icon-arrow_left',
                  'icon icon-arrow_right' => 'icon icon-arrow_right',
                  'icon icon-case_details_icon_1' => 'icon icon-case_details_icon_1',
                  'icon icon-case_details_icon_2' => 'icon icon-case_details_icon_2',
                  'icon icon-case_details_icon_3' => 'icon icon-case_details_icon_3',
                  'icon icon-checklist' => 'icon icon-checklist',
                  'icon icon-comment' => 'icon icon-comment',
                  'icon icon-comment_black' => 'icon icon-comment_black',
                  'icon icon-creative_communication_1' => 'icon icon-creative_communication_1',
                  'icon icon-creative_communication_2' => 'icon icon-creative_communication_2',
                  'icon icon-creative_communication_3' => 'icon icon-creative_communication_3',
                  'icon icon-creative_communication_4' => 'icon icon-creative_communication_4',
                  'icon icon-group' => 'icon icon-group',
                  'icon icon-paper_plane' => 'icon icon-paper_plane',
                  ...
                  'icon icon-share_black' => 'icon icon-share_black',
                  'fa fa-500px' => '500px',
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'ekit-hederfooter' ); ?>">
					<option value=""><?php esc_html_e( 'Select Icon', 'ekit-hederfooter' ); ?></option>
