...
function ekit_megamenu_ajax_select_func( WP_REST_Request $request ) {
    $class = new Ekit_Ajax_Select2_Api();
    return $class->call_method($request);
}

add_action( 'rest_api_init', function () {
    register_rest_route( 'ekit-megamenu-megamenuajaxselect2/v1', '/(?P<method>\w+)/', array(
        'methods' => 'GET',
        'callback' => 'ekit_megamenu_ajax_select_func',
