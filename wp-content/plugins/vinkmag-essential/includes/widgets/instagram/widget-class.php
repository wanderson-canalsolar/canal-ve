...
class Vinkmag_Instagram extends WP_Widget
{
    function __construct() {

        $widget_opt = array(
            'classname'     => 'vinkmag-widget',
            'description'   => 'vinazine instagrams'
        );
        
        parent::__construct('vinkmag-instagram', esc_html__('vinazine instagram', 'vinkmag-essntial'), $widget_opt);
    }
        ...
        <div class="instagram_photo">
            <?php if(!empty($data)): ?>
                <?php foreach ($data as $xs_media):?>
                    <a href="<?php echo esc_url($xs_media->link) ?>" target="_blank" rel="noopener" ><img src="<?php echo esc_url($xs_media->images->thumbnail->url) ?>"></a>
                <?php endforeach; ?>
            <?php endif; ?>    
        </div>
        <?php
    ...
    function form($instance){
        ...
        $user_id = '';
        $media_count = 10;
        $title = esc_html__( 'Instagram', 'vinkmag-essntial' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            ...
            <?php esc_html__( 'Log in and get my Access Token and User ID' , 'vinkmag-essntial' ); ?>
            </a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>"><?php esc_html__( 'Access token:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php esc_html__( 'User ID:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_count' )); ?>"><?php esc_html__( 'Count:' , 'vinkmag-essntial' ); ?></label>
