...
class Vinkmag_Footer_Address extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'vinkmag-footer-address',
            'description'   => esc_html__('Vinkmag footer address','vinkmag-essntial')
        );
        
        parent::__construct('xs-footer-address', esc_html__('Vinkmag footer address', 'vinkmag-essntial'), $widget_opt);
    }
    ...
    function widget( $args, $instance ){
        ...
        <div class="media xs-footer-info-and-payment">
            ...
            <div class="media-body">
                ...
                <?php endif; ?>
                <?php if($map_btn != ''): ?>
                    <a href="https://maps.google.com/maps?<?php echo vinkmag_return($query_string);?>" class="xs-map-popup btn btn-primary">
                        <?php if($map_icon != ''): ?>
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Footer address', 'vinkmag-essntial' );
        }
        if(isset($instance['message'])){
            $message = $instance['message'];
        }else{
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'message' )); ?>"><?php esc_html_e( 'Message' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_icon' )); ?>"><?php esc_html_e( 'Media icon:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_icon' )); ?>"><?php esc_html_e( 'Map icon:' , 'vinkmag-essntial' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_btn' )); ?>"><?php esc_html_e( 'Map button:' , 'vinkmag-essntial' ); ?></label>
