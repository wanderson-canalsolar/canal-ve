...
if ( ! class_exists( 'EKIT_HF_Notices' ) ) :

	class EKIT_HF_Notices {
		...
		public function __construct() {
			...
			add_action( 'wp_ajax_ekit-hf-notices', array( $this, 'dismiss' ) );
		...
		function enqueue_scripts() {
			wp_register_script( 'ekit-hf-sites-notices', EKIT_HF_URL . 'assets/js/ekit-hf-sites-notices.js', array( 'jquery' ), EKIT_HF_VER, true );
		}
		...
		function show_notices() {
			...
			foreach ( self::$notices as $key => $notice ) {
				...
				$classes = array( 'ekit-hf-notice', 'notice' );
				...
				// Notice ID.
				$notice_id    = 'ekit-hf-sites-notices-id-' . $notice['id'];
				$notice['id'] = $notice_id;
				if ( ! isset( $notice['id'] ) ) {
					$notice_id    = 'ekit-hf-sites-notices-id-' . $notice['id'];
					$notice['id'] = $notice_id;
		...
		public static function markup( $notice = array() ) {
			...
			wp_enqueue_script( 'ekit-hf-sites-notices' );
