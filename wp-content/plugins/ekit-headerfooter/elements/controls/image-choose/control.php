...
class Ekit_Image_Choose_Controler extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'css-image-choose-contrdol',  EKIT_ELEMENTS_URL . 'controls/image-choose/assets/css/style.css', [], '1.0.0' );
		wp_enqueue_style( 'css-image-choose-contrdol' );

		// script	
		wp_register_script( 'js-image-choose-control',  EKIT_ELEMENTS_URL . 'controls/image-choose/assets/js/script.js' );
