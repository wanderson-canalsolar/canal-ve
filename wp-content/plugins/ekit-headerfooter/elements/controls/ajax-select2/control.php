...
class Ekit_Ajax_Select2_Controler extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// script	
		wp_register_script( 'js-ajax-select2-control',  EKIT_ELEMENTS_URL . 'controls/ajax-select2/assets/js/script.js' );
		wp_enqueue_script( 'js-ajax-select2-control' );
	}
